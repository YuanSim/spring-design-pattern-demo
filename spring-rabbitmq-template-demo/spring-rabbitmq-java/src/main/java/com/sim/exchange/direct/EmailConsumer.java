...
public class EmailConsumer {
    ...
    private static final String QUEUE_NAME = "direct-email-sim";
    ...
    private static  final String EMAIL_ROUTING_KEY = "sim.email";
    ...
    */
    public static void direct() throws IOException, TimeoutException {
         ...
         * 可以绑定多个路由
         */
        channel.queueBind(QUEUE_NAME,EXCHANGE_NAME, EMAIL_ROUTING_KEY);
